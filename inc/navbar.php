<nav class="navbar" role="navigation" aria-label="main navigation">
  <div class="navbar-brand">
    <a class="navbar-item" href="index.php?vista=home">
      <img src="./img/tf2.png" width="35" height="40">
    </a>
  ...
  <div id="navbarBasicExample" class="navbar-menu">
    <div class="navbar-start">
      ...
      <div class="navbar-item has-dropdown is-hoverable">
        ...
        <div class="navbar-dropdown">
          <a class="navbar-item" href="index.php?vista=pizza_new">
            Nuevo
          </a>
          <a class="navbar-item" href="index.php?vista=pizza_list">
            Lista
          </a>
          <a class="navbar-item">
            Buscar
      ...
      <div class="navbar-item has-dropdown is-hoverable">
        ...
        <div class="navbar-dropdown">
          <a class="navbar-item" href="index.php?vista=ingredientes_new">
            Nuevo
          </a>
          <a class="navbar-item" href="index.php?vista=ingredientes_list">
            Lista
          </a>
          <a class="navbar-item">
            Buscar
